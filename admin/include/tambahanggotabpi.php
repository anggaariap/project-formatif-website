    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus"></i> Tambah Anggota BPI</h3>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card card-info">
      ...
      <?php }?>
      <?php if($_GET['notif']=="tambahdepartemenkosong"){?>
        <div class="alert alert-danger" role="alert">Maaf data departemen wajib di isi</div>
      <?php }?>
      <?php if($_GET['notif']=="gambarsalah"){?>
        <div class="alert alert-danger" role="alert">Maaf gambar yang diizinkan hanya .jpg</div>
      <?php }?>
      <?php }?>
      <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-anggota-bpi" enctype="multipart/form-data">
        <div class="card-body">
