            ...
            <div class="col-sm-12">
              <?php if(!empty($_GET['notif'])){?>
                <?php if($_GET['notif']=="tambahuserberhasil"){?>
                    <div class="alert alert-success" role="alert">User Berhasil Ditambah</div>
                <?php } else if($_GET['notif']=="editberhasil"){?>
                  <div class="alert alert-success" role="alert">Data User Berhasil Diubah</div>
        ...
        <tbody>
          <?php
            ...
            if (isset($_POST["katakunci"])){
              ...
              $sql_k .= " where `nama` LIKE '%$katakunci_up%' ";
              }
              ...
              if($jum_halaman==0){
                //tidak ada halaman
                  ...
                  if (isset($_POST["katakunci"])){
                      $katakunci_up = $_POST["katakunci"];
                      if($halaman!=1){
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=user&katakunci=$katakunci_up&halaman=1'>First</a></li>";
